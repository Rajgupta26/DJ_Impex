...
/** Comprehensive list of country calling codes for WhatsApp enquiries (Alphabetical A-Z). */
...
export const enquirySchema = z.object({
  ...
  countryCode: z
    .string()
    .trim()
    .min(2, "Please choose a country code.")
    .regex(/^\+[0-9]{1,6}$/, "Please choose a valid country code."),
  whatsappNumber: z
    .string()
    .trim()
